...
The primary goal is an NDIS offload to the miniport for hardware support.
The secondary goal is to provide software fallback in the OS when hardware support is not available.
